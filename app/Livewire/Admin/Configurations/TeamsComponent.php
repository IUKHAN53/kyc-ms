...
class TeamsComponent extends Component
{
    ...
    public function render()
    {
        if ($this->mode === 'index') {
            ...
            return view('livewire.admin.configurations.teams-component', [
                'teams' => $teams,
            ])->layout('layouts.admin-configurations');
        }

        return view('livewire.admin.configurations.teams-component')->layout('layouts.admin-configurations');
    }
